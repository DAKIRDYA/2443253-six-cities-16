...
Сервер доступен по адресу: https://16.design.htmlacademy.pro/six-cities.
Спецификация по взаимодействию с сервером в формате OpenAPI — https://16.design.htmlacademy.pro/spec/six-cities.
